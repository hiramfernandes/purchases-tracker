...
public class NfcReceipt
{
    ...
    [JsonPropertyName("source")] public DataSource? Source { get; set; }

    public Qr? Qr { get; set; }

    [JsonPropertyName("merchant")] public ReceiptMerchant? Merchant { get; set; }
    ...
    [JsonPropertyName("retrieval")] public Retrieval? Retrieval { get; set; }
}
...
public class DataSource
{
    ...
    [JsonPropertyName("ingested_at")] public DateTime? IngestedAt { get; set; }
...
public class Qr
{
    [JsonPropertyName("decoded_ok")] public bool? DecodedOk { get; set; }

    [JsonPropertyName("payload_raw")] public string? PayloadRaw { get; set; }

    [JsonPropertyName("payload_type")] public string? PayloadType { get; set; }

    [JsonPropertyName("url")] public string? Url { get; set; }

    [JsonPropertyName("fallback_used")] public bool? FallbackUsed { get; set; }

    [JsonPropertyName("fallback_source")] public string? FallbackSource { get; set; }
}
...
public class AccessKeyDecomposed
{
    ...
    [JsonPropertyName("AAMM")] public string? AAMM { get; set; }

    [JsonPropertyName("cnpj_digits")] public string? CnpjDigits { get; set; }
...
public class Totals
{
    ...
    [JsonPropertyName("discount")] public object? Discount { get; set; }

    [JsonPropertyName("surcharge")] public object? Surcharge { get; set; }

    [JsonPropertyName("total")] public double? Total { get; set; }

    [JsonPropertyName("currency")] public string? Currency { get; set; }

    [JsonPropertyName("payment")] public List<Payment>? Payment { get; set; }
}
...
public class Payment
{
    ...
    [JsonPropertyName("auth_code")] public object? AuthCode { get; set; }
}
...
public class Taxes
{
    ...
    [JsonPropertyName("ibpt_approx")] public IbptApprox? IbptApprox { get; set; }
}

public class IbptApprox
{
    [JsonPropertyName("federal")] public double? Federal { get; set; }
...
public class Item
{
    ...
    [JsonPropertyName("confidence")] public Confidence? Confidence { get; set; }
}

public class Confidence
{
    [JsonPropertyName("description")] public double? Description { get; set; }

    [JsonPropertyName("quantity")] public double? Quantity { get; set; }

    [JsonPropertyName("prices")] public double? Prices { get; set; }
}

public class Retrieval
{
    [JsonPropertyName("fingerprints")] public Fingerprints? Fingerprints { get; set; }

    [JsonPropertyName("keywords")] public List<string>? Keywords { get; set; }

    [JsonPropertyName("geo_hint")] public GeoHint? GeoHint { get; set; }
}
...
public class Fingerprints
{
    ...
    [JsonPropertyName("total_brl_cents")] public int? TotalBrlCents { get; set; }
}
